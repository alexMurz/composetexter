package com.alexmurz.composetexter.modules.topic.viewmodel

import androidx.lifecycle.ViewModel
import com.alexmurz.composetexter.apperror.service.AppErrorHandler
import com.alexmurz.composetexter.apperror.service.withErrorHandling
...
class TopicListViewModel :
    ...
    private val errorRelay by inject<AppErrorHandler>()
    ...
    fun create() {
        log("create - Start, check context")
        scope.launch {
            runForTopics {
                listOf(service.createTopic(context, "123", "321"))
            }
        }
    }
